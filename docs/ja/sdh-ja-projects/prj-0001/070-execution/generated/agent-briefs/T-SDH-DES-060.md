...
- docs/ja/handbook/templates/tsd-input-template.md
...
```bash
dojo exec claim --project shj-0001 --task T-SDH-DES-060 --by <agent> --msg "start"
# edit / validate / lint
dojo exec complete --project shj-0001 --task T-SDH-DES-060 --by <agent> --msg "done"
```
...
```bash
dojo exec block --project shj-0001 --task T-SDH-DES-060 --by <agent> --msg "blocked: <reason>; need=<next action>; ref=<path or issue>"
```
