...
| name                                 | 成果物名                                | 概要                                                       |
| ------------------------------------ | --------------------------------------- | ---------------------------------------------------------- |
| `upsert-rulebook.md`                    | rules 新規・更新プロンプト              | `*-rulebook.md` の新規作成・更新を起動                        |
...
| `rulebook-lifecycle.md`                 | rules ライフサイクルプロンプト          | rules 作成から派生成果物生成までのライフサイクルを起動     |
| `rulebook-lifecycle-all.md`             | rules ライフサイクル一括実行プロンプト  | 全 `*-rulebook.md` を対象にライフサイクルを順次実行           |
| `reverse-rulebook.md`                   | 逆引き rules 生成プロンプト             | 既存の成果物ファイルから rules を逆生成する処理を起動      |
