...
| name                   | 成果物名                    | 概要                                                             |
| ---------------------- | --------------------------- | ---------------------------------------------------------------- |
| `upsert-rules`         | upsert-rules スキル         | `*-rulebook.md` の新規作成・更新ワークフロー                        |
...
| `rules-lifecycle-all`  | rules-lifecycle-all スキル  | 全 `*-rulebook.md` を対象にライフサイクルを順次実行するワークフロー |
...
| `rules-lifecycle-all.md`             | rules ライフサイクル一括実行プロンプト  | 全 `*-rulebook.md` を対象にライフサイクルを順次実行           |
