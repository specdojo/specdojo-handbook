...
- tags: `business`, `rulebook-lifecycle`, `agent-ultra`
...
- docs/ja/specdojo/instructions/bps-instruction.md
- docs/ja/specdojo/templates/bps-input-template.md
...
```bash
specdojo exec claim --project shj-0001 --task T-SDH-BIZ-010 --by <agent> --msg "start"
# edit / validate / lint
specdojo exec complete --project shj-0001 --task T-SDH-BIZ-010 --by <agent> --msg "done"
```
...
```bash
specdojo exec block --project shj-0001 --task T-SDH-BIZ-010 --by <agent> --msg "blocked: <reason>; need=<next action>; ref=<path or issue>"
```
