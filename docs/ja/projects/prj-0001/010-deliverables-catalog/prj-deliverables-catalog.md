...
- 配置先: `docs/ja/projects/prj-0001/030-project-management`
...
- 配置先: `docs/ja/projects/prj-0001/030-project-management/020-controls`
...
| ----------- | ------------------------- | -------------------------------- | ----------------------- | ---------------------------------------------------------- |
| rules       | 手動作成／Agentによる生成 | `docs/ja/specdojo/rulebooks/`    | `<name>-rulebook.md`    | 各ドキュメントの作成ルール本体（SSOT）                     |
| instruction | rules から派生            | `docs/ja/specdojo/instructions/` | `<name>-instruction.md` | rules を生成 AI 向けの実行指示として再構成したテンプレート |
| sample      | rules から派生            | `docs/ja/specdojo/samples/`      | `<name>-sample.md`      | rules に準拠した最小の記述例                               |
