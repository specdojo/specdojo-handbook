...
- スキーマ版は、ファイル種別ごとの Schedule スキーマで管理する。
  - `sch-milestones.yaml`: `docs/shared/schemas/v1/sch-milestones.schema.yaml`
  - `sch-defaults.yaml`: `docs/shared/schemas/v1/sch-defaults.schema.yaml`
  - `sch-track-<track>.yaml`: `docs/shared/schemas/v1/sch-track.schema.yaml`
  - `sch-config-<track>.yaml`: `docs/shared/schemas/v1/sch-config.schema.yaml`
  - `sch-agent-overrides-<track>.yaml`: `docs/shared/schemas/v1/sch-agent-overrides.schema.yaml`
