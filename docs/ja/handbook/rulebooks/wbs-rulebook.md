...
本ルールで示す YAML 構造は、`docs/shared/schemas/v1/wbs.schema.yaml` を正とします。
...
- スキーマ版は `docs/shared/schemas/v1/` のような版付きディレクトリで管理する。
- 現行版は `docs/shared/schemas/v1/wbs.schema.yaml` とする。
