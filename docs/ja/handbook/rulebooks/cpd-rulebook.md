...
Mermaid 記法そのもののルールは [cpd-mermaid-rulebook.md](cpd-mermaid-rulebook.md) を参照してください。
...
- Mermaid 記法ルールは [cpd-mermaid-rulebook.md](cpd-mermaid-rulebook.md) に従います。
- 図には、少なくとも以下を含めます。
  - Person（いる場合）
...
- Mermaid 記法（CPD）: [cpd-mermaid-rulebook.md](../rulebooks/cpd-mermaid-rulebook.md)
