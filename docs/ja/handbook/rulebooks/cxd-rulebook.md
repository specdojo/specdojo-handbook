...
Mermaid 記法そのもののルールは [cxd-mermaid-rulebook.md](cxd-mermaid-rulebook.md) を参照してください。
...
- Mermaid 記法ルールは [cxd-mermaid-rulebook.md](cxd-mermaid-rulebook.md) に従います。
- 図には、少なくとも以下を含めます。
  - Person（人/ロール）
...
- Mermaid 記法（CXD）: [cxd-mermaid-rulebook.md](../rulebooks/cxd-mermaid-rulebook.md)
