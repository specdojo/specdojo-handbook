...
| ドキュメント | 英語名称 | 推奨ファイル名 | 目的 | 主な内容 |
| --- | --- | --- | --- | --- |
| 現状定義（As-Is） | As-Is Definition | - | 変更前のベースラインを定義し、比較の基準を固定する | 現行業務仕様の対象範囲、前提、参照元、凍結時点 |
...
| 移行テスト計画（リハーサル計画） | Migration Test Plan | `mtp-<term>` | 移行リハーサルの実施計画を定義し、切替前に妥当性を検証する | テスト範囲、シナリオ、環境、判定基準、是正計画 |
