...
| ID                  | 参照先                                    | Owner    | 備考               |
| ------------------- | ----------------------------------------- | -------- | ------------------ |
| nfr-reliability     | `docs/ja/specdojo/nfr-reliability.md`     | QA/Dev   | 信頼性要件         |
| nfr-availability    | `docs/ja/specdojo/nfr-availability.md`    | Ops      | 可用性要件         |
| nfr-maintainability | `docs/ja/specdojo/nfr-maintainability.md` | Dev/Ops  | 保守性要件         |
| nfr-integrity       | `docs/ja/specdojo/nfr-integrity.md`       | Dev/QA   | 完全性要件         |
| nfr-security-safety | `docs/ja/specdojo/nfr-security-safety.md` | Security | 機密性・安全性要件 |
