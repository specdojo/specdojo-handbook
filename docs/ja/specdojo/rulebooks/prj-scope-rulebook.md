...
| based_on   | プロジェクト概要、憲章、上位方針など   | 任意 |
...
- 対象機能、対象成果物、対象基盤は粒度を揃えます（例: 「販売登録」「在庫管理」「公開基盤」のような大項目）。
...
判断順序が重要な場合は、優先順位付きの箇条書きにしてよいです。
...
- 承認者
- 影響を受ける成果物（成果物カタログ、WBS、スケジュール、RACI、管理計画など）
...
- 承認者: 誰が最終判断するか
- 記録: 判断理由を DEC、課題一覧、Issue、PR、変更要求ログのいずれかに残す（可能ならリンクを付ける）
