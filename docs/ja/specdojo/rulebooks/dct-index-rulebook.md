...
- H1 はドキュメントの役割が一読で判別できる名称とし、「成果物カタログ」のように対象と目的を含めて記述する。
...
- 「`根拠` と `based_on` は原則として一致させるが、差分があっても構わない」という運用方针を明記する。
...
[dct-index-sample.md](../samples/dct-index-sample.md)

## 9. 生成 AI への指示テンプレート

[dct-index-instruction.md](../instructions/dct-index-instruction.md)
