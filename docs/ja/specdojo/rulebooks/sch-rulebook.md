...
- スキーマ版は、ファイル種別ごとの Schedule スキーマで管理する。
  ...
  - `sch-config-<track>.yaml`: `docs/specdojo/schemas/v1/sch-config.schema.yaml`
  - `sch-agent-overrides-<track>.yaml`: `docs/specdojo/schemas/v1/sch-agent-overrides.schema.yaml`
