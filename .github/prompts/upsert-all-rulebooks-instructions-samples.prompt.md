# docs-contents-guide を正として rulebook / instruction / sample を一括アップサート

@file:.github/skills/upsert-all-rulebooks-instructions-samples/SKILL.md

`/upsert-all-rulebooks-instructions-samples` は、上記 SKILL に定義された手順と実行ルールに従って実行してください。
