# docs-contents-guide を正として rulebook を一括アップサート

@file:.github/skills/upsert-all-rulebooks/SKILL.md

`/upsert-all-rulebooks` は、上記 SKILL に定義された手順と実行ルールに従って実行してください。
